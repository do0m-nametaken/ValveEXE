...
tf2.launch('-windowed', '-novid',
	...
	#
	# in that case, use generate_navmesh_2.py
	'+map', 'ctf_2fort',
...
logwatcher = RegexLogWatcher(
	logfile=tf2.logFile, regex="\.nav' saved\.",
	...
	join=True, # set to True if you want to block/pause further execution once starting until the logwatcher has automatically stopped
	)
logwatcher.start()
